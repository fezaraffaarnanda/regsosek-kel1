...
public class Ruta implements Model {
    ...
    public String getInsertStatement() {
        return "INSERT INTO ruta (provinsi, kabkot, kecamatan, desakel, sls,"
                + "kelompok_keluarga, no_bangunan, no_keluarga, id_landmark) "
                + "VALUES (?,?,?,?,?,?,?,?,?)";
    ...
    public void prepareInsertStatement(PreparedStatement pstmt) throws SQLException {
        pstmt.setInt(1, getLokasi().getProvinsi());
        ...
        pstmt.setString(6, kelompokKeluarga);
        pstmt.setInt(7, noUrutBangunan);
        pstmt.setInt(8, noUrutKeluarga);
        pstmt.setString(9, idLandmark);
        //throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
